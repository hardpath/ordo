namespace Ordo.Commands
{
    internal static class HelpCommand
    {
        public static void Execute()
        {
            ...
            Console.WriteLine("  - delete events     Delete ORDO events from Calendar.");
